...
const LoanSubCategory = ({navigation, route}) => {
  const {loanId, banner} = route?.params;
  const data = [
    {
      id: 1,
      name: 'Personal Loans',
      image: 'uploads/website-images/city-2023-05-07-11-42-14-6058.webp',
    },
    {
      id: 2,
      name: 'Home Loans',
      image: 'uploads/website-images/city-2023-05-07-11-43-44-5919.webp',
    },
    {
      id: 3,
  ...
  const fetchData = async () => {
    await axios
      .get('https://inhouse.hirectjob.in/api/loan/' + loanId)
      .then(res => {
      ...
      <ImageBackground
        ...
        <View style={styles.headerContainerServices}>
          ...
          <View style={styles.headerTextContainerServices}>
            <Text style={styles.headerTextServices}>Loan Types</Text>
          </View>
        ...
        <View style={styles.contentContainerServices}>
          <ScrollView
            ...
            <View>
              <Image
                source={{
                  uri: 'https://inhouse.hirectjob.in/' + banner,
                }}
