...
const SubService = ({navigation, route}) => {
  const {ServiceId, banner} = route?.params;
  ...
  const fetchData = async () => {
    await axios
      .get('https://inhouse.hirectjob.in/api/service/' + ServiceId)
      .then(res => {
      ...
      <ImageBackground
        ...
        <View style={styles.headerContainerServices}>
          ...
          <View style={styles.headerTextContainerServices}>
            <Text style={styles.headerTextServices}>Services List</Text>
          </View>
                  ...
                  renderItem={({item}) => (
                    <View style={[styles.rowServices]}>
                      <TouchableOpacity
                        ...
                        style={styles.serviceItemServices}>
                        <TouchableOpacity
                          style={styles.serviceIconContainerServices}>
                          <Image
                            source={{
